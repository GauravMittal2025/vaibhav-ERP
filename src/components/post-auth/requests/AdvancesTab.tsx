...
import { DollarSign, Search, SlidersHorizontal, Check, X, Clock } from 'lucide-react';

export const AdvancesTab: React.FC = () => {
  // Mock advance requests
